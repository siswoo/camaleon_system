...
?>
	...
	<div class="seccion1" id="seccion1" style="margin-top: 3rem;">
		<div class="row ml-3 mr-3" style="margin-top: 4rem;">
			<div class="col-12 text-center" style="font-weight: bold; font-size: 30px; text-transform: uppercase;">Módulo de PQR</div>
...
<div class="modal fade" id="modal_listo1" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
	<div class="modal-dialog modal-lg" role="document">
		<form action="#" method="POST" id="formulario_listo1" style="">
			<div class="modal-content">
				<div class="modal-header">
					<h5 class="modal-title" id="exampleModalLabel">Respuesta al Confirmar</h5>
				...
				<div class="modal-body">
					<div class="row">
						<div class="col-12 form-group form-check">
							...
							<input type="text" id="respuesta" name="respuesta" class="form-control" minlength="4" required>
						</div>
					</div>
				</div>
...
<script type="text/javascript">
    ...
    $("#formulario_listo1").on("submit", function(e){
		e.preventDefault();
