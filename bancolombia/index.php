			        ...
			        <tbody id="resultados">
			        	<?php
			        		...
			        		while($row1 = mysqli_fetch_array($consulta1)) {
			        			...
			        			echo '
			        				<tr id="tr_'.$id.'">
			        					<td class="text-center" id="empresa'.$id.'">'.$empresa.'</td>
			        					<td class="text-center" id="referencia'.$id.'">'.$referencia.'</td>
			        					<td class="text-center" id="fecha'.$id.'">'.$fecha.'</td>
			        					<td class="text-center" id="resultado'.$id.'">'.$resultado.'</td>
			        					<td class="text-center" id="valor'.$id.'">'.$valor.'</td>
			        					<td class="text-center" id="fecha_inicio'.$id.'">'.$fecha_inicio.'</td>
