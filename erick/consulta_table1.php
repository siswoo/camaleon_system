...
while($row1 = mysqli_fetch_array($consulta1)) {
	...
	while($row2 = mysqli_fetch_array($consulta2)) {
		...
		if($row2['id_paginas']==4){
			$sql_paginas1 = "SELECT * FROM bonga WHERE id_modelo = ".$modelo_id." and fecha_desde BETWEEN '".$fecha_desde."' AND '".$fecha_hasta."' and  fecha_hasta BETWEEN '".$fecha_desde."' AND '".$fecha_hasta."'";
			$consulta_paginas1 = mysqli_query($conexion,$sql_paginas1);
			while($row3 = mysqli_fetch_array($consulta_paginas1)) {
		...
		if($row2['id_paginas']==6){
			$sql_paginas1 = "SELECT * FROM cam4 WHERE id_modelo = ".$modelo_id." and fecha_desde BETWEEN '".$fecha_desde."' AND '".$fecha_hasta."' and  fecha_hasta BETWEEN '".$fecha_desde."' AND '".$fecha_hasta."'";
			$consulta_paginas1 = mysqli_query($conexion,$sql_paginas1);
			while($row3 = mysqli_fetch_array($consulta_paginas1)) {
