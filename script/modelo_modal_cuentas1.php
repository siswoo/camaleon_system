...
while($row1 = mysqli_fetch_array($consulta1)) {
	...
	while($row2 = mysqli_fetch_array($consulta2)) {
		...
		$html.="
		<!--<p><span style='font-weight:bold;'>Cuenta #".$contador1.":</span>-->
		";
		...
		$html.="
		<!--<button type='button' class='btn btn-info' style='margin-bottom:1rem;' value='hidden_cuenta_".$pagina_nombre."_".$contador1."' onclick='hidden_cuentas1(this.value);'>Cuenta #".$contador1."</button>-->
		...
		<div class='row' id='div_hidden_cuenta_".$pagina_nombre."_".$contador1."' style='display:none;'>
			...
			<div class='col-12'>
				<div class='input-group'>
					<span style='margin-top:1rem; width:100px;'>Estatus: &nbsp;</span>
					<input class='form-control mb-2 mt-2' type='text' value='".$modelo_estatus."'>
				</div>
			</div>
			-->
			";
