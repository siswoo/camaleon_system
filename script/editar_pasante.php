<?php
	...
	$sql1 = "UPDATE pasantes SET tipo_documento = '$tipo_documento', numero_documento = '$numero_documento', primer_nombre = '$primer_nombre', segundo_nombre = '$segundo_nombre',primer_apellido = '$primer_apellido', segundo_apellido = '$segundo_apellido', genero = '$genero',correo = '$correo', telefono1 = '$telefono1', barrio = '$barrio', direccion = '$direccion' WHERE id = ".$id;
