...
if($_SESSION["rol"]!=1){
	...
	$sql1 = "SELECT * FROM presabana_inactivos WHERE sede = ".$_SESSION['sede']." and inicio BETWEEN '".$inicio."' AND '".$fin."' and fin BETWEEN '".$inicio."' AND '".$fin."' and total_pesos >=1";

	//$sql1 = "SELECT * FROM modelos WHERE sede = ".$_SESSION['sede'];

}else{

	$sql1 = "SELECT * FROM presabana_inactivos WHERE inicio BETWEEN '".$inicio."' AND '".$fin."' and fin BETWEEN '".$inicio."' AND '".$fin."' and total_pesos >=1";
