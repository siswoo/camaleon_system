...
if($extension == 'pdf'){
    ...
    if($ancho>$alto){
        ...
        unlink($location.'foto_cedula_con_cara.jpg');
        unlink($location.'foto_cedula_con_cara.pdf');
        imagejpeg($imagen_optimizada, $location.'foto_cedula_con_cara'.'.jpg');
    }else if($ancho<$alto){
...
$sql3 = "DELETE FROM modelos_documentos WHERE id_documentos = 8 and id_modelos = ".$modelo_id;
...
$sql2 = "INSERT INTO modelos_documentos (id_documentos,id_modelos,tipo,fecha_inicio) VALUES (8,'$modelo_id','$extension','$fecha_inicio')";
