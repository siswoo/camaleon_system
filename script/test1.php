...
/*
$desprendible_fecha_desde 	= '2021-11-16';
$desprendible_fecha_hasta 	= '2021-11-30';
$desprendible_trm 			= 3700;
*/
	...
	if($contador2>=1){
		while($row2 = mysqli_fetch_array($consulta2)) {
			...
			if($row2['id_paginas']==7){
				echo $sql_paginas1 = "SELECT * FROM streamate WHERE nickname = '".$row2['usuario']."' and fecha_desde BETWEEN '".$desprendible_fecha_desde."' AND '".$desprendible_fecha_hasta."' and  fecha_hasta BETWEEN '".$desprendible_fecha_desde."' AND '".$desprendible_fecha_hasta."'";
				$consulta_paginas1 = mysqli_query($conexion,$sql_paginas1);
				while($row3 = mysqli_fetch_array($consulta_paginas1)) {
