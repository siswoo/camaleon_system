...
if($extension == 'pdf'){
    unlink($location.'documento_identidad.jpg');
    unlink($location.'documento_identidad.pdf');
    move_uploaded_file ($_FILES['file']['tmp_name'],$location.'documento_identidad.pdf');
}else{
    ...
    if($ancho>$alto){
        ...
        unlink($location.'documento_identidad.jpg');
        unlink($location.'documento_identidad.pdf');
        imagejpeg($imagen_optimizada, $location.'documento_identidad'.'.jpg');
    }else if($ancho<$alto){
...
$sql3 = "DELETE FROM modelos_documentos WHERE id_documentos = 2 and id_modelos = ".$modelo_id;
...
$sql2 = "INSERT INTO modelos_documentos (id_documentos,id_modelos,tipo,fecha_inicio) VALUES (2,'$modelo_id','$extension','$fecha_inicio')";
