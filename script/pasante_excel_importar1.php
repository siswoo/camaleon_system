...
for($i=2;$i<=$limite;$i++){
  ...
  $primer_nombre = utf8_decode($worksheet->getCell('C'.$i));
  $segundo_nombre = utf8_decode($worksheet->getCell('D'.$i));
  $primer_apellido = utf8_decode($worksheet->getCell('E'.$i));
  $segundo_apellido = utf8_decode($worksheet->getCell('F'.$i));
