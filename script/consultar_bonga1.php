...
while($row1 = mysqli_fetch_array($registro1)) {
    ...
    while($row3 = mysqli_fetch_array($registro3)) {
        ...
        $sql4 = "SELECT * FROM chaturbate WHERE nickname = '".$nickname_modelo_chaturbate."' and tokens >= 1 and fecha BETWEEN  '".$fecha_desde_Bonga."' AND  '".$fecha_hasta_Bonga."'";
        ...
        while($row8 = mysqli_fetch_array($registro8)) {
            ...
            $sql7 = "SELECT * FROM stripchat WHERE nickname ='".$nickname_modelo_stripchat."' and tokens >= 1 and fecha BETWEEN  '".$fecha_desde_Bonga."' AND  '".$fecha_hasta_Bonga."'";
