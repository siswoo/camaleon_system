        ...
        <div class="dashboard-wrapper">
            <div class="page-header">
                <div class="container-fluid dashboard-content ">
                    ...
                    <p class="pageheader-text">Documentos</p>
                        ...
                        <form id="formulario1" method="POST" action="#" enctype="multipart/form-data">
                            <div class="row">
                                ...
                                <div class="col-6 mt-3">
                                	<label form="file">Identifique Documento</label>
                                	<select class="form-control" id="documento" name="documento" required>
                                		...
                                		<option value="7">Antecedentes Disciplinarios</option>
                                		<option value="11">Antecedentes Penales</option>
                                	</select>
                                </div>
                                <div class="col-6 mt-3">
                                	<label form="file">Archivo a Subir (Solo formato PDF)</label>
