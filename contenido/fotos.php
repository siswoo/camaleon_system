        ...
        <div class="dashboard-wrapper">
            <div class="page-header">
                <div class="container-fluid dashboard-content ">
                    <h2 class="pageheader-title">Fotos </h2>
                    <p class="pageheader-text">Fotos</p>
                    ...
                    <div class="container">
                            ...
                            <div class="row">
                                ...
                                <div class="col-6 mt-3">
                                	...
                                	<select class="form-control" id="documento" name="documento" required>
                                		...
                                		<option value="13">Fotos Sensuales</option>
                                	</select>
                                </div>
                                <div class="col-6 mt-3">
						...
						<div class="row mt-3" id="respuesta1"></div>
                    </div>
                </div>
            </div>
        </div>
...
<script type="text/javascript">
	...
	$("#formulario1").on("submit", function(e){
        ...
        fd.append('condicion','subir_fotosensual1');
        $.ajax({
	...
	function consultar1(){
		...
		$.ajax({
            ...
            data: {
                "id": id,
                "documento": documento,
                "condicion": "consultar_fotosensual1",
            },
