...
$sql1 = "SELECT * FROM descuento WHERE responsable = 1722 and fecha_desde BETWEEN '2021-05-01' AND '2021-05-15' and fecha_hasta BETWEEN '2021-05-01' AND '2021-05-15'";
...
$writer->save('Exportable Descuento Corte 1 Mayo '.$fecha_inicio.'.xlsx');
header("Location: Exportable Descuento Corte 1 Mayo ".$fecha_inicio.".xlsx");
