...
$sql1 = "SELECT * FROM descuento WHERE concepto = 'Restaurante' and fecha_desde BETWEEN '2021-05-16' AND '2021-05-31' and fecha_hasta BETWEEN '2021-05-16' AND '2021-05-31'";
...
$writer->save('../resources/documentos/miscelanea/Reporte Jaime 1 '.$fecha_inicio1.'.xlsx');
header("Location: ../resources/documentos/miscelanea/Reporte Jaime 1 ".$fecha_inicio1.".xlsx");
