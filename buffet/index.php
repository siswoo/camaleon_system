	    ...
	    <div class="row">
			        		...
			        		while($row1 = mysqli_fetch_array($consulta1)) {
			        			...
			        			echo '
			        				<tr id="tr_'.$id.'">
			        					...
			        					<td class="text-center" id="precio_'.$id.'">'.$precio.'</td>
		    ...
		    <div class="col-12 div_app" style="display: none;">
		    	...
		    	<table id="example2" class="table row-border hover table-bordered" style="font-size: 12px; color:rgba(50,55,66,1); border-radius: 5px;">
			        ...
			        <tbody>
			        	<?php
			        		$sql1 = "SELECT * FROM usuarios WHERE nombre = 'buffet'";
			        		...
			        		while($row2 = mysqli_fetch_array($consulta2)) {
			        			...
			        			echo '
			        				<tr id="tr2_'.$descuento_id.'">
			        					<td class="text-center" id="descuento_id_'.$descuento_id.'">'.$descuento_id.'</td>
