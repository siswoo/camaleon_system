...
$pdf->Ln(5);
$pdf->SetFont('Times','',10);
$pdf->MultiCell(0,5,utf8_decode('Yo, _____________________________________(Nombre de la modelo), persona mayor de edad, identificado(a) con la cédula de ciudadanía No._____________________________, actuando de manera libre, consiente, haciendo uso de mi buen estado emocional, físico y psicológico. una vez informado(a), sobre las actividades con fines comerciales y sus respectivas consecuencias, que realizará la_____________________________________ (persona o estudio autorizado), para posicionarme y comercializar mis actividades como modelo webcam por medio de la industria del video chat, otorgo en forma libre y autónoma mediante la firma del presente documento, mi consentimiento y autorización a: BERNAL GROUP. Para la realización de las siguientes actividades:'),0,'');
$pdf->Ln(5);
...
Dirección:_______________________'),0,'');
